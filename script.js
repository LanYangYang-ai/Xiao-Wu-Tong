...
function searchVideosForSelected() {
    ...
    dom.videoGrid.innerHTML = "";
    var url = "https://search.bilibili.com/video?keyword=" + encodeURIComponent(combinedKw + " 高中物理 考点精讲") + "&order=click&duration=0&tids_1=21;
...
function searchKnowledgeNode(nodeName, biliKeywords) {
    ...
    var url = "https://search.bilibili.com/video?keyword=" + encodeURIComponent(biliKeywords + " 高中物理 考点精讲") + "&order=click&duration=0&tids_1=21;
